        ...
        .then((data) => {
          if (data.result) {
            ...
            if ((weekdayText)) {
              ...
              weekdayText = "Information currently unavailable";
              setHours(weekdayText);
            }
          } else {
            return;
          }
      ...
      <>
        <div className="card">
          <div className="card-body shadow">
            ...
            <button onClick={() => window.open(attraction.website)}>
              {attraction.website}
            </button>
            <br />
            <button onClick={() => window.open(attraction.url)}>
